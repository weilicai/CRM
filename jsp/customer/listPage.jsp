									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<c:if test="${pageBean.currentPage!=1}">
													[<a href="${pageContext.request.contextPath}/customer_listPage.action?currentPage=${currentPage-1}">前一页</a>]
												</c:if>
												<c:if test="${pageBean.currentPage != pageBean.totalPage}">
													[<a href="${pageContext.request.contextPath}/customer_listPage.action?currentPage=${currentPage+1}">后一页</a>] 
												</c:if>												
